...
const AgendaData: {
  ...
  morning: [{
    ...
    slide: 'https://slides.com/tonyq/remote-team',
  }, {
    time: '09:40 - 10:00',
    ...
    slide: 'https://drive.google.com/file/d/1OOV55pClWtNBBM7StU7wepH39-UZb0lM/view?usp=sharing',
  }, {
    time: '10:00 - 10:20',
    ...
    slide: 'https://drive.google.com/file/d/17Q4iAYbfqQv1yWUdtGBUlo9iXaRW5fSu/view?usp=sharing',
  }, {
    time: '10:20 - 10:30',
    title: '休息時間',
  }, {
    ...
    slide: 'https://www.canva.com/design/DAEIbbb_dVE/X9rGR-8N_nBqeCpXrSzWRQ/edit?category=tACFasDnyEQ',
  }, {
    time: '10:50 - 11:10',
    ...
    slide: 'https://drive.google.com/file/d/1H-GLPCfbbn-NwIiG0p2Jj8Ipl5NPsr_s/view?usp=sharing',
  }, {
    time: '11:10 - 11:30',
    title: '你喜歡寫程式嗎？為自己學習寫程式',
    description: '人生是個沒有對錯的選擇題，發掘自己寫程式最純粹的樂趣',
    speaker: SpeakerObj.rexchen, // Rex Chen,
    slide: 'https://drive.google.com/file/d/1GW90Ag1z1747GkhDOYny9ZoQ1FajqiUD/view?usp=sharing',
  }, {
    time: '11:30 - 12:00',
  ...
  afternoon: [{
    ...
    slide: 'https://blog.lalacube.com/mei/Reveal_amp_and_the_missing_parts.php?page=1',
  }, {
    time: '14:40 - 15:00',
    title: 'Lerna 的套件管理術',
    description: '拆分模組是軟體開發的重點之一。常言道模組拆得好，開發、Debug 沒煩惱。本節將介紹拆分模組的依據、Lerna 指令、CICD 等結合。',
    speaker: SpeakerObj.FongX777, // Fong,
    slide: 'https://drive.google.com/file/d/1EbS2EO7iVXbZkda1GyeFAFQ0g_RoP9QO/view?usp=sharing',
  }, {
    time: '15:00 - 15:20',
    title: '用錯非同步，服務一樣會卡住',
    ...
    slide: 'https://docs.google.com/presentation/d/14tuekWY4I1BSJbsFnOGdsZP1c0ocR6gXiuiH7s5yHeM/edit?usp=sharing',
  }, {
    time: '15:20 - 15:40',
    ...
    slide: 'https://drive.google.com/file/d/1wvDCsSHICHyNLx-O8fERdb2P_XHi_1Yd/view?usp=sharing',
  }, {
    time: '15:40 - 15:50',
    title: '休息時間',
  }, {
    ...
    slide: 'https://drive.google.com/file/d/1P5Z4zMVJ2I72LPa3r6jvEVwn3AdAEATq/view?usp=sharing',
  }, {
    time: '16:10 - 16:30',
    ...
    slide: 'https://speakerdeck.com/coodoo/cai-yong-typescript-qian-ni-gai-kao-lu-de-shi-jian-shi',
  }, {
    time: '16:30 - 17:00',
